...
class Query:
    ...
    def query_search(self, genres, release_date, upperYear, ratings):
        # List to return
        self.movieList = []
        self.moviedata = pd.read_csv('dataset.csv',
        ...
        try:
            ...
            if mydb.is_connected():
                ...
                mycursor.execute("""
                                    ...
                                    AND ratings >= %s AND ratings < %s + 1""", (genres, release_date, upperYear,
                                                                                ratings, ratings))

                print('selecting.....')
                print('selection is made....')
                for movie in mycursor.fetchall():
                    # Appends the movie and its year to the list
