...
The file had several columns with different information that was no use to us using .drop
Code below was used to format the above mentioned file using the panda library
For example the genre column had characters like [ or } so we iterated through all rows and replaced those characters
Duplicates were also dropped
'''
